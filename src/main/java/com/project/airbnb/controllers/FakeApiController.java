...
public class FakeApiController {
    ...
    // "3f7c534f-0773-499d-88fb-ea84a4f3307d",
    // "67ef9d8a-6bfa-4aef-b054-2da123c9a578",
    // "a011993e-84dd-4bac-a036-e6d44752f164"
    // );
    // List<String> amenityId = Arrays.asList(
    // "ce2ee62b-682f-4287-9807-e086b31bad2d",
    // "b2aee30b-40fc-4e3f-9f1a-fdf8dea9a48f",
    // "94e759ce-d468-4417-92b5-c028926a7e19",
    // "f691bb22-4c68-4d9b-b6a3-823aac72d174"
    // );
    //
    // Set<Amenity> amenitySet = new HashSet<>();
    // for(String i : amenityId){
    // Amenity amenity = amenityRepository.findById(i).orElseThrow(()->new
    // AppException(ErrorCode.AMENITY_NOT_EXISTED));
    ...
    // Ward ward = wardRepository.findById(randomIdWard).orElseThrow(() -> new
    // AppException(ErrorCode.WARD_NOT_EXISTED));
    // Category category = categoryRepository.findById(randomIdCate).orElseThrow(()
    ...
    // public ResponseEntity<String> createListing(@RequestBody ListingRequest
    // listingRequest) {
    ...
    // return ResponseEntity.status(HttpStatus.CREATED).body("lat: " + latitude + "
    // - long: " + longitude + ", address: " + address);
    // }
